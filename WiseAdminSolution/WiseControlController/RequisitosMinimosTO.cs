...
{
    public class RequisitosMinimosTO : ControllerMaster.ControllerMaster
    {
        #region "atributos"
                ...
                if (!(dt == null))
                {
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                RequisitosMinimosTO item = new RequisitosMinimosTO(false);
        ...
        public RequisitosMinimosTO(bool conbd)
        {
