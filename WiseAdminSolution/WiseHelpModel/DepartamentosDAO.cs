...
namespace WiseHelpModel
{
    ...
    {
        #region "Métodos"
        public DataTable GerenciaDepartamentos(int codigodp, String email, int ramal, String nome, int acao, String ConnectionString)
        {
            try
            {
                parametros = new List<Parametro>();
                parametros.Add(new Parametro("@CODIGO", codigodp));
