...
{
    public class PessoaTO:ControllerMaster.ControllerMaster
    {
        #region "Atributos"
        private int _codigo;
        ...
        #endregion
        #region "Métodos"
        public List<object> GerenciaPessoas(int acao, int tpcadastro, String cargo, String login, String Senha, String ConnectionString)
        {
            try
            {
                ...
                if (!(dt == null))
                {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    PessoaTO item = new PessoaTO(false, true);
        ...
        {
            if (conbd) { this._dao = new PessoaDAO(); }
            if (instanciadependentes) { this._departamento = new DepartamentoTO(false); }
        }
